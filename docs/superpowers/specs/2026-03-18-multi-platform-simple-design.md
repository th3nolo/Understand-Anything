...
```
Fetch and follow instructions from https://raw.githubusercontent.com/th3nolo/Understand-Anything/refs/heads/main/understand-anything-plugin/.codex/INSTALL.md
```
